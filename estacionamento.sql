...
CREATE VIEW CodigandoPlaca as --com CREATE VIEW 
SELECT placa,
	hsEntrada,
	hsSaida
...
SELECT * FROM CodigandoPlaca; -- Como se fosse a cópia do resultado do query anterior
...
SELECT DISTINCT placa FROM veiculo, estaciona; -- uso de DISTINCT

SELECT nome, cpf FROM cliente WHERE nome IS NOT NULL;